...
class ApiConfig(ApiConfigInterface):
    ...
    def load_config(self):
        ...
        self.paradex_account = os.getenv('PARADEX_ACCOUNT', "0x7221409e5d3aa8468f602a4da191ccb9ec8323f002314b185861306563056ec")

        # Hex of the account private key (Stark Key)
        self.paradex_account_private_key = os.getenv('PARADEX_ACCOUNT_PRIVATE_KEY', "0x7c328b51cf6718323ff1900b004695903266b420bdc20382dd3ad4d895b2aba")

        self.ethereum_hd_phrase = os.getenv('ETHEREUM_HD_PHRASE', "")
        self.ethereum_account = os.getenv('ETHEREUM_ACCOUNT', "0xf6dc0DfEbc0cCa92cEF8181FaD031b1281ABD198")
        self.ethereum_private_key = os.getenv('ETHEREUM_PRIVATE_KEY', "a6d7c6c9a7348a0b211e0e6f1384e056994f519f5ed4acaf0a692ed936f8ef10")
